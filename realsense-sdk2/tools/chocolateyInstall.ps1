...
$packageArgs = @{
    ...
    url          = 'https://github.com/IntelRealSense/librealsense/releases/download/v2.18.0/Intel.RealSense.SDK.exe'
    checksum     = 'f11bea81e0a301b026744069799e43e5fcef79700cf72595073a7c6687ef3005'
    checksumType = "sha256"
